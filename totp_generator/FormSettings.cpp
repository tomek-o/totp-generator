...
void __fastcall TfrmSettings::FormShow(TObject *Sender)
{
	...
	chbTotpStorePasswordInFile->Checked = tmpSettings.Totp.storePasswordInFile;
	edTotpPassword->Text = tmpSettings.Totp.password;
}
//---------------------------------------------------------------------------
...
void __fastcall TfrmSettings::btnApplyClick(TObject *Sender)
{
	...
	tmpSettings.Totp.storePasswordInFile = chbTotpStorePasswordInFile->Checked;
	tmpSettings.Totp.password = edTotpPassword->Text.Trim();
